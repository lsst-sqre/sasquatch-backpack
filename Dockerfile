# Sourced from https://github.com/lsst-sqre/gafaelfawr/blob/main/Dockerfile
...
FROM python:3.13.12-slim-forky AS base-image
...
# Install the Backpack Python application.
ADD . /app
RUN --mount=type=cache,target=/root/.cache/uv \
