...
This page provides procedures and guidelines for developing and contributing to sasquatch-backpack.

Scope of contributions
======================

sasquatch-backpack is an open source package, meaning that you can contribute to sasquatch-backpack itself, or fork sasquatch-backpack for your own purposes.

Since sasquatch-backpack is intended for internal use by Rubin Observatory, community contributions can only be accepted if they align with Rubin Observatory's aims.
For that reason, it's a good idea to propose changes with a new `GitHub issue`_ before investing time in making a pull request.

sasquatch-backpack is developed by the Rubin Observatory SQuaRE team.

.. _GitHub issue: https://github.com/lsst-sqre/sasquatch-backpack/issues/new
...
To develop sasquatch-backpack, create a virtual environment with your method of choice (like virtualenvwrapper) and then clone or fork, and install:
...
1. Installs sasquatch-backpack in an editable mode with its "dev" extra that includes test and documentation dependencies.
...
sasquatch-backpack uses scriv_ to maintain its change log.
